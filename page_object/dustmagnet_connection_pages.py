...
class DustMagnetConnectionPages(DeviceConnectionPages):
    def __init__(self, common_driver):
        ...
        # device_model should be "DustMagnet 5410i", "DustMagnet 5210i", "DustMagnet 5440i", "DustMagnet 5240i"
    ...
    def tap_device_model(self):
        ...
        try:
            ...
            for n in range(1, model_number + 1):
                ...
                model_xpath_extend_string1 = "/android.widget.TextView"
                # device image string
                model_xpath_extend_string2 = "/android.widget.ImageView"

                # get model name
                model_xpath_name_string = model_xpath_base_string + model_xpath_extend_string1
                ...
                #print(model_list)
            # find out the "DustMagnet" device layout by device name
            model_element = model_list.get("DustMagnet", "No Such Device").get("DustMagnet")

            if model_element != "No Such Device":
                self.tap_element(model_element)

            return model_list["DustMagnet"]
